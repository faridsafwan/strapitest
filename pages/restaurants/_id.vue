        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <ul>
                <li v-for="dish in selectedDishes" :key="dish._id" class="card-text mb-2">
...
const apiUrl =
  process.env.API_URL || "https://quiet-plains-18812.herokuapp.com";
